...
#'
#' This is a specialty function that has several preliminary requirements. The output produces the 30 years averaged historical climate variables for the provided CSV file.
...
hist30YClimateNA <- function(file,dateR,tFrame,exe,outdir = dirname(file)){
  fileN <- basename(file)
